...
[![Travis-CI Build Status](https://travis-ci.org/ijlyttle/tidytemps.svg?branch=master)](https://travis-ci.org/ijlyttle/tidytemps)
[![Coverage Status](https://img.shields.io/codecov/c/github/ijlyttle/tidytemps/master.svg)](https://codecov.io/github/ijlyttle/tidytemps?branch=master)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/tidytemps)](https://cran.r-project.org/package=tidytemps)
